...
function showWelcome() {
    ...
    let dist = getDistance(120.45680331758501, 36.37721963850324, ipLocation.data.lng, ipLocation.data.lat); //修改自己的经度（121.413921）纬度（31.089290）
